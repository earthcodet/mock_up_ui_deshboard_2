            ...
            isOptionChart: {
                ...
                tooltip: {
                    ...
                    <p style='display: flex;align-items: center;justify-content: center'> 
                        <span style="width: 10px;height: 10px;background-color: #5e72e4;">
                        </span> 
                       $` + `{c}k
                    </p>`,
                    trigger: "axis",
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <div className='process-bar-box'>
                                                                <div className='process-bar-item color-box1' style={{ width: '60%' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p className='pb-box'>
                                                            70%
                                                    <div className='process-bar-box'>
                                                                <div className='process-bar-item color-box2' style={{ width: '70%' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p className='pb-box'>
                                                            80%
                                                    <div className='process-bar-box'>
                                                                <div className='process-bar-item color-box3' style={{ width: '80%' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p className='pb-box'>
                                                            75%
                                                    <div className='process-bar-box'>
                                                                <div className='process-bar-item color-box4' style={{ width: '75%' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p className='pb-box'>
                                                            30%
                                                    <div className='process-bar-box'>
                                                                <div className='process-bar-item color-box5' style={{ width: '30%' }}>
